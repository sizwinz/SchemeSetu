...
export default function HomePage() {
  return (
    <div className="space-y-8 pb-16">
      {/* Sovereign Statutory Banner establishing MoSJE / NSFDC mandate */}
      <OfficialMoSJEBanner />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        {/* Sovereign Hero Header with 4 Statutory Pillars */}
        <section className="text-center max-w-3xl mx-auto pt-2 space-y-3">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-amber-50 border border-amber-200/80 text-amber-800 text-xs font-semibold shadow-2xs">
            ...
            <span>Problem Statement ID 26092 • Ministry of Social Justice &amp; Empowerment</span>
          </div>
          ...
          <p className="text-xs sm:text-sm text-slate-600 leading-relaxed max-w-2xl mx-auto">
            Connecting Scheduled Caste entrepreneurs and students with tailored MoSJE credit schemes covering up to 90% of project costs at 4.0% to 8.0% interest rates through solvent, low-NPA Channel Partners.
          </p>

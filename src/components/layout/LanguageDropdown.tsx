  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center space-x-1.5 px-2.5 sm:px-3 py-1.5 rounded-full border border-slate-300 text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors cursor-pointer shadow-2xs focus:outline-hidden focus:ring-2 focus:ring-amber-500/40"
      ...
      {isOpen && (
        <div
          role="listbox"
          className="absolute right-0 mt-1.5 w-48 sm:w-56 rounded-2xl bg-white border border-slate-200/90 shadow-lg py-1.5 z-50 animate-in fade-in zoom-in-95 duration-100"
        >

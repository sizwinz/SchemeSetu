  ...
  return (
    <section className="bg-white rounded-2xl border border-slate-200/90 shadow-xs p-4 sm:p-7 space-y-5 sm:space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 pb-4 border-b border-slate-100">
        ...
        <Link
          href="/locator"
          className="inline-flex items-center space-x-1.5 px-3 py-2 rounded-xl border border-slate-300 hover:border-slate-400 bg-slate-50 hover:bg-slate-100 text-xs font-semibold text-slate-800 transition-colors shrink-0 shadow-2xs group self-start md:self-auto"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        {/* 1. SCA */}
        <div className="p-3.5 sm:p-4 rounded-xl border border-slate-200/80 bg-slate-50/50 space-y-2">
